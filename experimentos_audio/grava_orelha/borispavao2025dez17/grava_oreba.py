...
from audio007.audio_utils import _tocagrava
...
with Carrinho(modo=modo) as c: 
    c.zera()
    _tocagrava(est_path, f'{quem}_{estimulo}.wav') # TODO: o primeiro grava mal as vezes
    ...
    for ang in angulos:
        ...
        _tocagrava(est_path, f'{quem}_{estimulo}_{ang}.wav')
